...
Source: the cotengra repository (https://github.com/jcmgray/cotengra). Direct competitor for our `OptimalContractionPath` / Netcon: most entries are FLOP/size cost comparisons.
